...
- エントリーポイント: `bayes_v3.py`
- 入力: マイク音声
- 出力: スピーカー音声
- UI: `ui_display.py` と連携

### 2.2 テキスト版

- エントリーポイント: `text_chat.py`
- 入力: コンソール入力
- 出力: コンソール表示
...
テキスト版エージェント本体。  
`bayes_v3.py` の会話制御を再利用しつつ、音声 I/O の代わりに標準入出力を使う。
