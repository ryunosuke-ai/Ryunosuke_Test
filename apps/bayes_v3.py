...
from core.models import ActionType, Phase, PhaseConfig, Observation, MemoryUpdate, ClassificationResult  # noqa: E402, F401
...
from core.phase_manager import PhaseManager, DEFAULT_PHASE_CONFIGS  # noqa: E402
    ...
    def run(self) -> None:
        ...
        if os.path.exists(ui_flag):
            try:
                ...
                pass
        print("⏳ UI起動待機中... (python3 -m streamlit run apps/ui_display.py を実行してください)")
